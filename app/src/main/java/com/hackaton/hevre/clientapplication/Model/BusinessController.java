...
public class BusinessController {
    ...
    private HashMap<Integer, Business> mBusinesses;
    ...
    public boolean addBusiness(int bId, String bName, Location bLocation, List<Tag> bTags)
    {
        boolean isAdded = false;

        if (!mBusinesses.containsKey(bId))
        {
            Business business = new Business(bId, bName, bTags, bLocation);
