...
public enum Tag {
    ...
    TAG_EMBASSY                              ("EMBASSY"),
    //TAG_ESTABLISHMENT                        ("ESTABLISHMENT"), // @Deprecated
    //TAG_FINANCE                              ("FINANCE"), // @Deprecated
    ...
    //TAG_GENERAL_CONTRACTOR                   ("GENERAL_CONTRACTOR"), // @Deprecated
    //TAG_GROCERY_OR_SUPERMARKET               ("GROCERY_OR_SUPERMARKET"), // @Deprecated
    TAG_GYM                                  ("GYM"),
    TAG_HAIR_CARE                            ("HAIR_CARE"),
    TAG_HARDWARE_STORE                       ("HARDWARE_STORE"),
    //TAG_HEALTH                               ("HEALTH"), // @Deprecated
    ...
    //TAG_PLACE_OF_WORSHIP                     ("PLACE_OF_WORSHIP"), // @Deprecated
    TAG_PLUMBER                              ("PLUMBER"),
    TAG_POLICE                               ("POLICE"),
